...
public class StreamLambdaHandler implements RequestStreamHandler {
	...
	static {
		try {
			handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(CowinAppApplication.class);
			...
			handler = new SpringBootProxyHandlerBuilder().defaultProxy().asyncInit(startTime)
					.springBootApplication(CowinAppApplication.class).buildAndInitialize();
